                                    ...
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Наименование производства</label>
                                            </div>
                                            <div id="facilityName" class="col-md-8 col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Описание деятельности
                                                    производства</label>
                                            </div>
                                            <div id="facilityDescription" class="col-md-8 col-6">
